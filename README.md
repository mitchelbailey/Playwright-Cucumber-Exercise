...
- [ ] --Extend the testing coverage with anything you believe would be beneficial-- I provided a list of the extra test features I would add in each of the Feature files as comments
